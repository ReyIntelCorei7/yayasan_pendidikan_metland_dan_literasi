    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-light mb-4">Artikel Tidak Ditemukan</h1>
          <Link to="/artikel" className="text-lime hover:underline">← Kembali ke Artikel</Link>
        </div>
      </div>
    );
  }
      ...
      {related.length > 0 && (
        <section className="bg-offwhite py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="text-3xl font-light mb-12">Artikel Terkait</h2>
